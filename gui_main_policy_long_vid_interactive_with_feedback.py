...
from models import *
from rewards_interactive_with_feedback import compute_reward
import vsum_tools
import timeit
...
def generate_summary_with_feedback(dataset_name, video_name, normal_summary_path, positive_feedback_idxes, negative_feedback_idxes):
    ...
    for epoch in range(start_epoch, max_epoch):
        ...
        for vid_idx in vid_idxes:
            ...
            idxes = get_existing_summary(normal_summary_path)

            #print (idx_to_ignore_for_init, len(idx_to_ignore_for_init))
            ...
            for pass_ in range(max_passes):
                ...
                while window_position <= video_length-subshot_length:
                    ...
                    for _ in range(num_episode):
                        ...
                        reward = compute_reward(full_video, seq, actions, positive_feedback_idxes, negative_feedback_idxes, use_gpu=use_gpu)
